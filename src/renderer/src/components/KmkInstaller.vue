<template>
  ...
  <BaseModal
    ...
    cancel-text="Cancel"
    secondary-text="Keep IDs"
    confirm-text="Generate New IDs"
    @close="isRestoreOpen = false"
    @secondary="restoreConfig(false)"
    @confirm="restoreConfig(true)"
  >
    <p>
      Do you want to generate new IDs for the restored configuration? This is only recommended if
      you are restoring a configuration from another keyboard.
    </p>
  </BaseModal>
    ...
    <div class="holder">
      ...
      >
        <div
          ...
          :class="{ 'grid-cols-1': !keyboardStore.firmwareInstalled }"
        >
